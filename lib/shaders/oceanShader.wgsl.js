...
export const oceanShader = `
      ...
      fn getTerrainHeight(worldX: f32, worldZ: f32) -> f32 {
        ...
        // Bounded island — MUST match getHeight in terrain.wgsl / shadow.wgsl / math.js
        // so the ocean's depth / foam / transparency line up with the real terrain (no phantom shallows).
        let R = 500.0;
